...
export const TopBar = () => {
  ...
  return (
    <>
      <div className=" max-[947px]:hidden  flex flex-row items-center h-15 fixed top-0 left-0 right-0 z-50 bg-white/3 backdrop-blur-xl shadow-lg shadow-sky-600/10 m-7 rounded-xl border-1 border-indigo-400/20 ">
        ...
        <div className="flex flex-grow justify-start gap-0 mx-10">
